...
\section{Introduction}
  ...
  One possible way to do this is to use a convolutional autoencoder, an unsupervised method that allows to train the convolutional layers independently from a classification task in order to learn a new data representation.
  % weight transfer
...
Masci et al. \citep{masci2011stacked} introduced the Convolutional Auto-Encoder (CAE), an unsupervised method for hierarchical feature extraction, which learns biologically plausible filters.
