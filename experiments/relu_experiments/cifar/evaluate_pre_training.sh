...
DATASET="CIFAR_1k"
CNN_LOG_FOLDER="00_1k_cifar_relu"
# CNN_LOG_FOLDER="dcy_debut"
CNN_CONFIG_FILE_PATH="$PARENT_DIR/relu_cnn.ini"
...
RUN_PREFIX="reference-random_initi_0.5drop"
...
RUN_PREFIX="pre-trained_0.5drop"
